//! `RDKit`-grounded red tests for directional bond boolean stereo cases.
...
fn load_cases() -> Vec<RdkitStereoGapCase> {
    serde_json::from_str(include_str!("../corpus/matching/stereo-gap-v4.rdkit.json"))
        .expect("valid RDKit stereo gap v4 fixture")
}

#[test]
fn stereo_gap_v4_cases_should_agree_with_frozen_rdkit_fixture() {
