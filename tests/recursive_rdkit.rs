//! RDKit-grounded recursive SMARTS parity tests.
...
fn load_cases() -> Vec<RdkitRecursiveCase> {
    serde_json::from_str(include_str!("../corpus/matching/recursive-v0.rdkit.json"))
        .expect("valid RDKit recursive fixture")
}

#[test]
fn recursive_matches_agree_with_frozen_rdkit_fixture() {
