//! RDKit-grounded stereo SMARTS parity tests.
...
fn load_cases() -> Vec<RdkitStereoCase> {
    serde_json::from_str(include_str!("../corpus/matching/stereo-v0.rdkit.json"))
        .expect("valid RDKit stereo fixture")
}

#[test]
fn stereo_matches_agree_with_frozen_rdkit_fixture() {
