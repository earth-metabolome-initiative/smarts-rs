...
fn load_cases() -> Vec<RdkitStereoGapCase> {
    serde_json::from_str(include_str!("../corpus/matching/stereo-gap-v2.rdkit.json"))
        .expect("valid RDKit stereo gap v2 fixture")
}

#[test]
fn stereo_gap_v2_cases_should_agree_with_frozen_rdkit_fixture() {
