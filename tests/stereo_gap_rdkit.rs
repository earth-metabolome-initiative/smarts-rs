//! RDKit-grounded red tests for still-missing query-side stereo cases.
...
fn load_cases() -> Vec<RdkitStereoGapCase> {
    serde_json::from_str(include_str!("../corpus/matching/stereo-gap-v1.rdkit.json"))
        .expect("valid RDKit stereo gap fixture")
}

#[test]
fn stereo_gap_cases_should_agree_with_frozen_rdkit_fixture() {
