//! `RDKit`-grounded red tests for directional bond `&` stereo cases.
...
fn load_cases() -> Vec<RdkitStereoGapCase> {
    serde_json::from_str(include_str!("../corpus/matching/stereo-gap-v5.rdkit.json"))
        .expect("valid RDKit stereo gap v5 fixture")
}

#[test]
fn stereo_gap_v5_cases_should_agree_with_frozen_rdkit_fixture() {
